...
import com.example.wheatherapp.viewmodel.TodayForecastViewModel

class TodayForecastFragment : Fragment() {

    companion object {
        fun newInstance() = TodayForecastFragment()
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(TodayForecastViewModel::class.java)
